# Contributing to Entity Services

Entity Services welcomes new contributors. This document will guide you 
through the process.
...
If you have questions about how to use Entity Services, you can ask on 
...
Fork the project [on GitHub](https://github.com/marklogic/entity-services/fork) 
and clone your copy.

    $ git clone git@github.com:username/entity-services.git
    $ cd entity-services
    $ git remote add upstream git://github.com/marklogic/entity-services.git

All bug fixes and new features go into the [develop](https://github.com/marklogic/entity-services/tree/develop) branch.
...
Go to https://github.com/username/entity-services and select your feature 
...
[issue tracker]: https://github.com/marklogic/entity-services/issues
