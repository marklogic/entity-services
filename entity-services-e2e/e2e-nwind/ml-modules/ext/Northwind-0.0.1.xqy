...
(:
 ...
 Generated at timestamp: 2017-07-14T13:47:44.221772-07:00
 :)
...
) as map:map
{
    ...
    (: The following property is a local reference.  :)
    let $ShipAddress  :=             es:extract-array($source-node/ShipAddress, northwind:extract-instance-ShipDetails#1)
    (: end customizations :)
