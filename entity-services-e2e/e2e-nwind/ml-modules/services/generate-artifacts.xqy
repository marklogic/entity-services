...
) as document-node()*
{
    ...
    return ($model ,  $next,
        ...
        xdmp:save($path || "/ml-modules/options/northwind-02.xml", $next=>es:search-options-generate()),
        xdmp:save($path || "/ml-schemas/Northwind-0.0.2.xsd", $next=>es:schema-generate()),
