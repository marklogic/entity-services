...
(: Generated at timestamp: 2016-09-09T10:46:19.921765-07:00                         :)
(:   Persisted by AUTHOR                                                            :)
(:   Date: DATE                                                                     :)
...
(:                                                                                  :)
 ...
 =>es:optional('QuantityPerUnit',        xs:string($source-node/Product/QuantityPerUnit))
...
(:                                                                                  :)
 ...
 =>es:optional('CustomerID',             northwind:extract-instance-Customer($source-node/Order/CustomerID))
 =>es:optional('OrderDate',              xs:dateTime($source-node/Order/OrderDate))
 =>es:optional('ShipDate',               xs:dateTime($source-node/Order/ShipDate))
 =>es:optional('ShipName',               xs:string($source-node/Order/ShipName))
 =>es:optional('ShipAddress',            xs:string($source-node/Order/ShipAddress))
 (: The following property is a local reference.                                     :)
 =>es:optional('OrderDetails',           northwind:extract-array($source-node/Order/OrderDetails, northwind:extract-instance-OrderDetail#1))
...
(:                                                                                  :)
 (: The following property is a local reference.                                     :)
 =>es:optional('ProductID',              northwind:extract-instance-Product($source-node/OrderDetail/ProductID))
