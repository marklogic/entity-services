...
(: 
 ...
 :   Generated at timestamp: 2016-04-19T21:29:38.489261-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
) as map:map
{
    json:object()
        ...
        =>i:with(true(),     'ProductID',                   data($source-node/Product/@ProductID))
...
) as map:map
{
    json:object()
        ...
        (: The following lines are generated from the Order entity type 
         ...
         : data to populate instances.
         :)
        =>i:with(true(),         'OrderID',                 data($source-node/Order/@OrderID))
