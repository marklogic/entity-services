...
(: This module was generated by MarkLogic Entity Services. 
 ...
 :   Generated at timestamp: 2016-04-05T17:00:56.74082-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
) as map:map
{
    ...
    let $_ := map:put($instance, "$attachments", $source-node)
    let $_ := northwind-Ref-Same-Document:include-if-exists($source-node/ProductID, $instance, 'ProductID', data($source-node/ProductID))
