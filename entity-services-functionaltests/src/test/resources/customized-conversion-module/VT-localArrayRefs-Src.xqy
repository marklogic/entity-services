...
(:
 ...
 Generated at timestamp: 2017-10-25T14:02:04.694218-07:00
 :)
...
(:~
 ...
 :)
declare function localArrayRefSrc:instance-to-canonical(
...
) as node()
{
        ...
        then xdmp:to-json( localArrayRefSrc:canonicalize($entity-instance) )/node()
        else localArrayRefSrc:instance-to-canonical-xml($entity-instance)
};
...
(:~
 ...
 :)
declare private function localArrayRefSrc:canonicalize(
    $entity-instance as map:map
) as map:map
{
    json:object()
                    ...
                    return
                        ...
                        case json:object
                            return
                                ...
                                else map:put($m, $key, localArrayRefSrc:canonicalize($instance-property))
                        ...
                        case json:array
                            return
                                ...
                                return
                                    ...
                                    then json:set-item-at($instance-property, $i, localArrayRefSrc:canonicalize($val))
                                    else (),
...
(:~
 ...
 : @return An XML element that encodes the instance.
 :)
declare private function localArrayRefSrc:instance-to-canonical-xml(
    $entity-instance as map:map
) as element()
{
                ...
                return
                    ...
                    case json:object+
                        return
                            ...
                            return element { $ns-key } { localArrayRefSrc:instance-to-canonical-xml($prop) }
                    (: An array can also treated as multiple elements :)
                    case json:array
                        return
...
{
    let $canonical := localArrayRefSrc:instance-to-canonical($entity-instance, $envelope-format)
...
{
    localArrayRefSrc:instance-to-envelope($entity-instance, "xml")
};
