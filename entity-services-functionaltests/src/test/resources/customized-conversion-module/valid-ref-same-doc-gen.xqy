...
(:
 ...
 Generated at timestamp: 2017-08-23T10:53:42.165005-07:00
 :)
...
(:~
 ...
 :)
declare function northwind-Ref-Same-Document:instance-to-canonical(
...
) as node()
{
        ...
        then xdmp:to-json( northwind-Ref-Same-Document:canonicalize($entity-instance) )/node()
        else northwind-Ref-Same-Document:instance-to-canonical-xml($entity-instance)
};
...
(:~
 ...
 :)
declare private function northwind-Ref-Same-Document:canonicalize(
    $entity-instance as map:map
) as map:map
{
    json:object()
                    ...
                    return
                        ...
                        case json:object
                            return
                                ...
                                else map:put($m, $key, northwind-Ref-Same-Document:canonicalize($instance-property))
...
(:~
 ...
 : @return An XML element that encodes the instance.
 :)
declare private function northwind-Ref-Same-Document:instance-to-canonical-xml(
    $entity-instance as map:map
) as element()
{
...
{
    let $canonical := northwind-Ref-Same-Document:instance-to-canonical($entity-instance, $envelope-format)
...
{
    northwind-Ref-Same-Document:instance-to-envelope($entity-instance, "xml")
};
