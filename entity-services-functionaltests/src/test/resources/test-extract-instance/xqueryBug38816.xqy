...
(: Generated at timestamp: 2016-08-08T16:49:52.331677-07:00                         :)
(:   Persisted by AUTHOR                                                            :)
(:   Date: DATE                                                                     :)
module namespace northwind-Ref-Combo-SameDocument-SubjectIri 
    = "http://refCombo#Northwind-Ref-Combo-SameDocument-SubjectIri-0.0.1";
...
(:                                                                                  :)
 ...
 =>es:optional('CustomerID',             northwind-Ref-Combo-SameDocument-SubjectIri:extract-instance-Customer($source-node/Order/CustomerID))
 ...
 =>es:optional('OrderDetails',           northwind-Ref-Combo-SameDocument-SubjectIri:extract-array($source-node/Order/OrderDetails, function($path) { json:object()=>map:with('$type', 'OrderDetails')=>map:with('$ref', $path/OrderDetails/text() ) }))
...
(:                                                                                  :)
 (: The following property is a local reference.                                     :)
 =>es:optional('ProductID',              northwind-Ref-Combo-SameDocument-SubjectIri:extract-instance-Product($source-node/OrderDetail/ProductID))
...
(:~
 ...
 :)
declare function northwind-Ref-Combo-SameDocument-SubjectIri:extract-array(
