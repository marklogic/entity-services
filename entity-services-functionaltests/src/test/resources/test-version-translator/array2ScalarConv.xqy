...
module namespace test-2-from-test-2 = "http://arr-to-scal#Test-2-0.0.2-from-Test-2-0.0.1";
...
(: 
 ...
 :   Generated at timestamp: 2016-07-22T15:14:43.140289-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
(: The following lines are generated from the 'Customer' entity type.               :)
 ...
 (: Warning: potential data loss, truncated array.                                   :)
    =>es:optional('Address',                xs:string#1( fn:head($source-node/Customer/Address) ))
