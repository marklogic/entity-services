...
module namespace sameSrc-from-sameSrc
    = "http://marklogic.com/sameSrcTgt/sameSrc-0.0.1-from-sameSrc-0.0.1";
...
(:
 ...
 Generated at timestamp: 2016-12-02T14:14:17.744956-08:00
 Persisted by AUTHOR
 Date: DATE

 Target Model sameSrc-0.0.1 Info:
...
{
    let $source-node := sameSrc-from-sameSrc:init-source($source, 'Customer')
...
{
    let $source-node := sameSrc-from-sameSrc:init-source($source, 'Product')
...
declare private function sameSrc-from-sameSrc:init-source(
    $source as node()*,
...
declare private function sameSrc-from-sameSrc:copy-attachments(
