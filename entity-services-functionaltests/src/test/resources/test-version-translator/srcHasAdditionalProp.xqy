...
module namespace test-3-from-test-3
    = "http://marklogic.com/test/Test-3-0.0.1-from-Test-3-0.0.1";
...
(:
 ...
 Generated at timestamp: 2016-10-26T22:36:32.571706-07:00
 Persisted by AUTHOR
 Date: DATE
...
) as map:map
{
    ...
    =>es:optional('NO TARGET',              xs:string($source-node/Customer/ContactName))
  :)
...
) as map:map
{
    ...
    (: The following properties are in the source, but not the target: 
    =>es:optional('NO TARGET',              xs:string($source-node/Product/Discontinued))
  :)
