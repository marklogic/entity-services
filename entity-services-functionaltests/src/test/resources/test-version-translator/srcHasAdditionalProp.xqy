...
module namespace test-3-from-test-3 = "http://marklogic.com/test/Test-3-0.0.1-from-Test-3-0.0.1";
...
(: 
 ...
 :   Generated at timestamp: 2016-07-22T15:14:41.876082-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
(:~
 ...
 :)
declare function test-3-from-test-3:convert-instance-Customer(
    $source-node as node()
) as map:map
{
    json:object()
...
(:~
 ...
 : @return A map:map instance that holds the data for this entity type.
 :)
declare function test-3-from-test-3:convert-instance-Product(
    $source-node as node()
) as map:map
{
    json:object()
...
(:~
 ...
 :)
declare function test-3-from-test-3:extract-array(
