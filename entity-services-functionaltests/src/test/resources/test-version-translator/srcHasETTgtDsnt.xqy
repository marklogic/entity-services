...
module namespace test-3-from-test-5 = "http://marklogic.com/test/Test-3-0.0.1-from-Test-5-0.0.1";
...
(: 
 ...
 :   Generated at timestamp: 2016-07-22T15:14:42.664248-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
(:~
 ...
 :)
declare function test-3-from-test-5:convert-instance-Customer(
    $source-node as node()
) as map:map
{
    json:object()
...
(:~
 ...
 :)
declare function test-3-from-test-5:extract-array(
