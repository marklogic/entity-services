...
module namespace test-3-from-test-5
    = "http://marklogic.com/test/Test-3-0.0.1-from-Test-5-0.0.1";
...
(:
 ...
 Test-5, version 0.0.1

 Modification History:
 Generated at timestamp: 2016-10-26T22:39:59.454601-07:00
 Persisted by AUTHOR
 Date: DATE
...
declare function test-3-from-test-5:convert-instance-Product(
    $source-node as node()
) as map:map
{
    json:object()
