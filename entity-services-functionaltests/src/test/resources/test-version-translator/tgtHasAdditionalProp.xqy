...
module namespace test-2-from-test-2 = "http://marklogic.com/test/Test-2-0.0.1-from-Test-2-0.0.1";
...
(: 
 ...
 :   Generated at timestamp: 2016-07-22T15:14:42.128919-07:00
 :   Persisted by AUTHOR
 :   Date: DATE
 :)
...
(: The following lines are generated from the 'Customer' entity type.               :)
 ...
 (: The following property was missing from the source type                          :)
    =>es:optional('ContactName',            xs:string#1( () ))
...
(:~
 ...
 : @return A map:map instance that holds the data for this entity type.
 :)
declare function test-2-from-test-2:convert-instance-Product(
    $source-node as node()
) as map:map
{
    json:object()
...
(: The following lines are generated from the 'Product' entity type.                :)
    =>   map:with('ProductName',            xs:string#1($source-node/Product/ProductName))
     =>es:optional('UnitPrice',              xs:integer#1($source-node/Product/UnitPrice))
     =>es:optional('SupplierID',             xs:integer#1($source-node/Product/SupplierID))
 (: The following property was missing from the source type                          :)
...
(:~
 ...
 :)
declare function test-2-from-test-2:extract-array(
