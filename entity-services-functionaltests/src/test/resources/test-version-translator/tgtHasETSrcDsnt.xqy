...
module namespace test-3-from-test-4 
    = "http://marklogic.com/test/Test-3-0.0.1-from-Test-4-0.0.1";
...
(: Test-4, version 0.0.1                                                            :)
(:                                                                                  :)
(: Modification History:                                                            :)
(: Generated at timestamp: 2016-08-08T14:41:53.275308-07:00                         :)
(:   Persisted by AUTHOR                                                            :)
(:   Date: DATE                                                                     :)
